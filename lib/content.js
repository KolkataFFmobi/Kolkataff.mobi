...
const NON_AFFILIATION =
  'This is an independent, informational resource and is not affiliated with, endorsed by, or connected to the organisers of Kolkata Fatafat. Every result is checked against multiple public sources before it is published here.';
...
const HOMEPAGE_SECTIONS = [
  ...
  },
  {
    ...
    bodyHtml:
      '<ul>' +
      '<li><strong>Checked before it is published.</strong> Every result is checked against multiple public sources; when sources disagree we publish the number confirmed by the majority and verify it again the next day.</li>' +
...
<h2>On accuracy</h2>
<p>Results are checked against multiple public sources before publication and corrections are applied when found, but momentary errors are possible; the declared result at the point of play, as recorded by the game's operators, always prevails over any website.</p>
<h2>On guidance</h2>
...
<p>Results are checked against multiple public sources before publication, but we cannot guarantee they are free of errors at every moment. Content here is provided as is for information; any decision you make based on it is your own responsibility. kolkataff.mobi does not publish tips, predictions, lucky numbers, or paid guidance of any kind &mdash; results and factual information only.</p>
<h2>Age and law</h2>
...
<p>Manage or delete cookies any time in your browser settings; every feature of this site works with cookies disabled.</p>
</section>`,
    faq: [
