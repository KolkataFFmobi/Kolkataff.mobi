...
const FAQ_CORE = [
  ...
  },
  {
    ...
    a: 'Bazi 1 is declared at about 10:03 IST and the last bazi at about 20:33 IST on weekdays, roughly every 90 minutes. On Sundays the day ends after Bazi 4, at about 14:33 IST. Exact times can vary by a few minutes, and each result on this site carries the time we published it, which is normally within minutes of the declaration.'
  },
  {
...
<p class="notice">${NON_AFFILIATION}</p>
    ...
    faq: [
      ...
      { q: 'Where do your results come from?', a: 'From three public sources cross checked against each other; the time we published it, and which sources reported it, are recorded with each result.' },
